...
const GalleryItem: React.FC<GalleryItemProps> = ({ listed,  setDetailView, sw, image, owner, token_id, price , description}) => {
    const truncatedText = owner.substring(0, 6) + ' ... ' + owner.substring(owner.length - 5, owner.length);
    ...
    return (
        <li className={`min-[1024px]:w-[${sw}%] min-[780px]:w-[33%] min-[540px]:w-[50%] max-[540px]:w-[100%] cursor-pointer pl-[20px] pr-[10px] mb-[20px] box-border`}>
